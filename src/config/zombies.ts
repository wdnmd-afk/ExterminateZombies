...
export const ZOMBIES = {
  walker: {
    id: 'walker', name: '普通', health: 50, speed: 45, damage: 10, attackRate: 1000,
  ...
  runner: {
    id: 'runner', name: '快速', health: 30, speed: 105, damage: 8, attackRate: 800,
  ...
  bomber: {
    id: 'bomber', name: '爆炸', health: 40, speed: 60, damage: 5, attackRate: 1000,
  ...
  lurker: {
    id: 'lurker', name: '裂颅感染体', health: 80, speed: 54, damage: 13, attackRate: 950,
  ...
  feral: {
    id: 'feral', name: '狂乱者', health: 34, speed: 125, damage: 9, attackRate: 680,
  ...
  headless: {
    id: 'headless', name: '无头感染体', health: 165, speed: 40, damage: 22, attackRate: 1250,
  ...
  rotting: {
    id: 'rotting', name: '腐烂感染体', health: 95, speed: 32, damage: 15, attackRate: 1050,
  ...
  crawler: {
    id: 'crawler', name: '伏地感染体', health: 28, speed: 118, damage: 7, attackRate: 620,
