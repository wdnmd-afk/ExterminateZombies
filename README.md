...
| 局内强化 | 24 张武器强化卡，覆盖全部 8 把武器；G2-7 首批接入弹链、四管齐射和连锁标记，拾取强化包后四选一，同武器强化可叠加 |
...
> 验证状态：2026-08-17 最新基线已通过 `npm test`（21 个文件、183 个用例）、`npm run typecheck` 与 `npm run build`；Chrome 客观验收已覆盖主菜单、军械带、第一关、第二关、无尽首 Boss 和 G2-7 首批 3 张变异卡，正式强化流程已进入第二关结算，V6 真人手感/听感仍待完成。
...
- 武器强化系统已恢复普通感染体 3%-5%、Boss 100% 的正式配置概率；G2-7 首批 3 张打法变异卡已完成 V0-V5，其余 21 张仍需分批迁移，组合强度、单局出现节奏和 V6 主观体验尚未完成。
